...
class LoginPage(BasePage):
    ...
    def should_be_register_form(self):
        ...
        assert self.is_element_present(*LoginPageLocators.EMAIL), "Email input is not present"
        assert self.is_element_present(*LoginPageLocators.PASSWORD1), "Password1 is not present"
        assert self.is_element_present(*LoginPageLocators.PASSWORD2), "Password2 is not present"
